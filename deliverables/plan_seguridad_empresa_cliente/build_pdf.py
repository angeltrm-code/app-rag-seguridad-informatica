#!/usr/bin/env python3
"""
build_pdf.py — Genera Plan_Seguridad_Empresa_CLIENTE.pdf
...
def main():
    ...
    parser.add_argument('--output', '-o', default='Plan_Seguridad_Empresa_CLIENTE.pdf')
    parser.add_argument('--html-only', action='store_true')
    args = parser.parse_args()

    here = Path(__file__).parent
    md = here / 'Plan_Seguridad_Empresa_CLIENTE.md'
